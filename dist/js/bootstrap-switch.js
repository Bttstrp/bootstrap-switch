...
(function (global, factory) {
  ...
  var $ = _jquery.default || window.jQuery || window.$;

  function getClasses(_ref, id) {
    ...
    return [state ? 'on' : 'off', size, disabled ? 'disabled' : undefined, readonly ? 'readonly' : undefined, indeterminate ? 'indeterminate' : undefined, inverse ? 'inverse' : undefined, id ? "id-".concat(id) : undefined].filter(function (v) {
      return v == null;
    });
  }
  ...
  function prvcontainerPosition() {
    ...
    this.$container.css('margin-left', function () {
      var values = [0, "-".concat(_this2.privateHandleWidth, "px")];

      if (_this2.options.indeterminate) {
        return "-".concat(_this2.privateHandleWidth / 2, "px");
      }
  ...
  function prvgetClass(name) {
    return "".concat(this.options.baseClass, "-").concat(name);
  }
      ...
      'change.bootstrapSwitch': function changeBootstrapSwitch(event, skip) {
        ...
        if (!skip) {
          if (_this4.$element.is(':radio')) {
            $("[name=\"".concat(_this4.$element.attr('name'), "\"]")).not(_this4.$element).prop('checked', false).trigger('change.bootstrapSwitch', true);
          }
  ...
  function prvlabelHandlers() {
    ...
    var handlers = {
      ...
      'mousemove.bootstrapSwitch touchmove.bootstrapSwitch': function mousemoveBootstrapSwitchTouchmoveBootstrapSwitch(event) {
        ...
        _this6.$container.css('margin-left', "".concat(dragEnd, "px"));
      },
  ...
  var BootstrapSwitch = /*#__PURE__*/function () {
    function BootstrapSwitch(element) {
      ...
      this.$on = $('<span>', {
        ...
        class: "".concat(prvgetClass.call(this, 'handle-on'), " ").concat(prvgetClass.call(this, this.options.onColor))
      });
      this.$off = $('<span>', {
        html: this.options.offText,
        class: "".concat(prvgetClass.call(this, 'handle-off'), " ").concat(prvgetClass.call(this, this.options.offColor))
      });
      this.$label = $('<span>', {
      ...
      this.$element.on('switchChange.bootstrapSwitch', function () {
        ...
        if (changeState === false) {
          if (_this9.$element.is(':radio')) {
            $("[name=\"".concat(_this9.$element.attr('name'), "\"]")).trigger('previousState.bootstrapSwitch', true);
          } else {
    ...
    _createClass(BootstrapSwitch, [{
      ...
      value: function setPrevOptions() {
        this.prevOptions = _objectSpread({}, this.options);
      }
    }, {
      key: "state",
      value: function state(value, skip) {
        ...
        if (this.$element.is(':radio')) {
          $("[name=\"".concat(this.$element.attr('name'), "\"]")).trigger('setPreviousOptions.bootstrapSwitch');
        } else {
